    ...
    >
      ...
      <div className="sm:flex justify-between">
        <div className="sm:w-[40%] sm:mr-5 mt-20">
          <h1 className=" text-[#5f5f5f]">
            Are you a fan of cryptocurrency?..Get the latest ranking on
            cryptocurrency rating using coinbile crypto rating system with
            accurate description of the present day cryptocurrency market value
          </h1>
